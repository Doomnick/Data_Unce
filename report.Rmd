...
Dotazník AFFEXX-KIDS-CZ zkoumá, jak se děti cítí během cvičení a zda je pro ně příjemné či nikoliv. Zjišťuje také, jak dřívější zkušenosti ovlivňují pocity a představy o cvičení. Celkový výsledek dotazníku je hodnocen na škále 1 až 5. Přičemž 1 znamená nechuť ke cvičení, nezájem. Číslo 5 znamená nadšení, vysokou motivaci ke cvičení.  \vspace{-0.5cm}
\begin{center}
...
Test kognice se skládá ze 3 následujících částí, u nichž jsou uvedeny výsledky (průměr značí o dostatečné úrovni v dané oblasti):
...
\\begin{tabular}{>{\\centering\\arraybackslash}p{3cm} p{12cm}} % První sloupec centrovaný, druhý bez hranic
\\hline
...
\\hline
\\cellcolor{", score2[1], "} \\multirow{1.9}{=}{\\centering \\textbf{", score2[2], "} \\\\ \\textbf{", score2[3], "}} & 
2. Test řazení názvů a čísel zaměřený na pracovní paměť a pozornost (poslechové cvičení): \\textbf{", cog_t16, "~dosažených bodů}. \\\\
\\hline
\\cellcolor{", score3[1], "} \\multirow{1.9}{=}{\\centering \\textbf{", score3[2], "} \\\\ \\textbf{", score3[3], "}} & 
